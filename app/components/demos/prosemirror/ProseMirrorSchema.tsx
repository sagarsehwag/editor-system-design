    ...
    },
    {
      ...
      "content": [
        ...
        <p className="section-note">
          ...
          Paragraphs contain inline content (text with optional marks). The schema defines these rules.
        </p>
      </div>
  ...
  marks: {
    ...
    link: { attrs: { href: {} } }
      ...
      <div className="prosemirror-section">
        ...
        <div className="schema-invalid-valid">
          <div className="schema-compare-panel invalid">
            <h5>❌ Invalid</h5>
            <p>Raw text directly in <code>doc</code></p>
            <div className="schema-mini-tree">
              <span className="node">doc</span>
              <span className="arrow">→</span>
              <span className="node bad">&quot;Hello&quot;</span>
            </div>
            <p className="hint">doc only accepts blocks (paragraph, blockquote, etc.), not raw text.</p>
          </div>
          <div className="schema-compare-panel valid">
            <h5>✅ Valid</h5>
            <p>Text wrapped in a <code>paragraph</code></p>
            <div className="schema-mini-tree">
              <span className="node">doc</span>
              <span className="arrow">→</span>
            ...
            <p className="hint">paragraph accepts inline content (text, marks). Rules satisfied.</p>
          </div>
        </div>

        <p className="schema-rules-summary">
          <strong>In plain terms:</strong> <code>doc</code> = &quot;I only take blocks.&quot;{' '}
          <code>paragraph</code> = &quot;I take text (with optional bold/italic).&quot;{' '}
          <code>blockquote</code> = &quot;I take blocks.&quot; The tree below shows a valid document
      ...
      <div className="prosemirror-section">
        ...
        <p>
          The <code>content</code> field uses a regex-like syntax to specify valid child sequences.
        </p>
      ...
      <div className="prosemirror-section">
        <h4>Node Groups</h4>
        <p>
          Add <code>group: &quot;block&quot;</code> to node specs. Use <code>block+</code> in content expressions instead of listing types.
        </p>
        <div className="schema-groups-visual">
          <div className="group-equivalence">
            <code>block+</code>
            <span className="equiv-arrow">≡</span>
            <code>(paragraph | blockquote | heading | code_block | horizontal_rule)+</code>
          </div>
      ...
      <div className="prosemirror-section">
        ...
        <p>
          By default, nodes with inline content allow <strong>all</strong> marks. But some nodes
          shouldn&apos;t — headings often stay plain, and <code>code_block</code> should never have bold or links.
          Use the <code>marks</code> property on a node spec to control which marks are allowed.
        </p>
        <div className="content-expr-grid">
          <div className="content-expr-item">
            <code>marks: &quot;_&quot;</code>
            <span>Wildcard — all marks allowed (default for inline content)</span>
          </div>
          <div className="content-expr-item">
            <code>marks: &quot;&quot;</code>
...
code_block: { content: "text*", group: "block", marks: "" }`}</code>
        ...
        <p className="section-note">
          ...
          stripped during transforms — e.g. pasting formatted text into a <code>code_block</code> loses the formatting.
        </p>
      </div>

      <div className="prosemirror-section schema-takeaways">
