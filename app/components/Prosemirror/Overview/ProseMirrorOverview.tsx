...
export default function ProseMirrorOverview() {
  return (
    <>
      <div className='overview-libraries'>
        <div className='overview-libraries-header'>
          <h3 className='overview-libraries-title'>Core Libraries</h3>
          <p className='overview-libraries-intro'>
            ProseMirror is not a single monolithic library — it&apos;s a collection of small, focused modules that each handle one concern. Together they form a toolkit for building rich text editors with full control over document structure, state management, rendering, and change tracking.
          </p>
        </div>
